...
#~   cdef int index
  ...
  try:
    ...
    spectrum_original_forward[int(round(peptide_mass * deepnovo_config.SPECTRUM_RESOLUTION)) - 1] = 1.0
  try:
  ...
  try:
    ...
    spectrum_holder[int(round(peptide_mass_C * deepnovo_config.SPECTRUM_RESOLUTION)) - 1] = 1.0
  try:
    spectrum_original_forward[int(round(peptide_mass_C * deepnovo_config.SPECTRUM_RESOLUTION))] = 1.0 # TODO(nh2tran): line-too-long
  except IndexError:
    spectrum_original_forward[int(round(peptide_mass_C * deepnovo_config.SPECTRUM_RESOLUTION)) - 1] = 1.0
  ...
  try:
    ...
    spectrum_holder[int(round(mass_C * deepnovo_config.SPECTRUM_RESOLUTION)) - 1] = 1.0
  ...
  try:
    ...
    spectrum_holder[int(round(peptide_mass_N * deepnovo_config.SPECTRUM_RESOLUTION)) - 1] = 1.0 # TODO(nh2tran): line-too-long
  try:
    spectrum_original_backward[int(round(peptide_mass_N * deepnovo_config.SPECTRUM_RESOLUTION))] = 1.0 # TODO(nh2tran): line-too-long
  except IndexError:
    spectrum_original_backward[int(round(peptide_mass_N * deepnovo_config.SPECTRUM_RESOLUTION)) - 1] = 1.0 # TODO(nh2tran): line-too-long
