...
def make_query_files(args):
    ...
    fasta_list = open(args.query, 'r').readlines()
    fasta_input_fp = args.query
...
def parse_args(test_argv = None):
    ...
    make_emapper_input_seq_source_group.add_argument(
        '--query',
        help='path to fasta file of query sequences generated by postnovo'
        )
    ...
    if args.command == 'make_emapper_input':
        ...
        if args.query != None:
            if not os.path.exists(args.query):
                parser.error(args.query + ' does not exist')
